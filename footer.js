...
(function () {
  ...
  function buildFooter() {
    return ''
      ...
      +     '<p style="font-family:\'Barlow\',sans-serif;font-size:0.8rem;color:#fff;text-align:center;margin-bottom:0.9rem;line-height:1.6;">A cada nova edição, primeiro na sua caixa de entrada. Entre uma e outra, entrevistas, bastidores e convites pros eventos que conectam empresários de verdade.</p>'
