...
(function () {
  ...
  function buildFooter() {
    return ''
      ...
      +     '<p style="font-family:\'Barlow\',sans-serif;font-size:0.8rem;color:#fff;text-align:center;margin-bottom:0.9rem;line-height:1.4;">Inscreva-se em nossa newsletter!<br>Seja o primeiro a receber as últimas notícias sobre negócios, design e cultura.</p>'
      ...
      +       '<label for="footer-newsletter-consent" style="font-family:\'Barlow\',sans-serif;font-size:0.8375rem;color:#fff;line-height:1.4;">Concordo em receber esta newsletter e entendo que posso cancelar a assinatura a qualquer momento.</label>'
      +     '</div>'
      +   '</div>'
      + '</div>'
