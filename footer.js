...
(function () {
  ...
  function buildFooter() {
    return ''
      ...
      +     '<p style="font-family:\'Barlow\',sans-serif;font-size:0.8rem;color:#fff;text-align:center;margin-bottom:0.9rem;line-height:1.6;">A cada nova edição, primeiro na sua caixa de entrada.<br>Entre uma e outra, entrevistas, bastidores e convites<br>pros eventos que conectam empresários de verdade.</p>'
      +     '<div style="display:flex;align-items:center;border-bottom:1px solid rgba(255,255,255,0.5);margin-bottom:1rem;">'
      +       '<input type="email" placeholder="Seu melhor e-mail" id="footer-newsletter-email" style="flex:1;background:none;border:none;outline:none;font-family:\'Barlow\',sans-serif;font-size:13px;color:#fff;padding:0.6rem 0;text-align:center;" />'
      ...
      +       '<label for="footer-newsletter-consent" style="font-family:\'Barlow\',sans-serif;font-size:0.8375rem;color:#fff;line-height:1.4;">Concordo em receber a newsletter. Posso cancelar quando quiser.</label>'
      +     '</div>'
      +   '</div>'
      + '</div>'
