/**
 * sumario-es.js — Revista BNI Business (Español)
 * Inyecta dinámicamente el popup de sumario en las páginas de artículos en español.
 * Cargar con <script src="../../../sumario-es.js?v=1" defer></script>
 *
 * Expone globalmente: abrirSumario(), fecharSumario()
 */
...
(function () {
  ...
  function buildHTML() {
    ...
    return ''
      ...
      +     '<button class="sumario-fechar" onclick="fecharSumario()">Cerrar ' + CLOSE_ICON + '</button>'
      +   '</div>'
      +   '<div class="sumario-grid">'

      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/eventos/" style="grid-column:1;grid-row:1;">'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/magna-marinho/" style="grid-column:1;grid-row:2;">'
      +   '<span class="sumario-secao">Caso de éxito</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">02</span><span class="sumario-desc">Magna Marinho</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/jrt-print/" style="grid-column:1;grid-row:3;">'
      +   '<span class="sumario-secao">Caso de éxito</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">03</span><span class="sumario-desc">José Roberto Teixeira</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/materia-de-capa/" style="grid-column:1;grid-row:4;">'
      +   '<span class="sumario-secao">Portada</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">04</span><span class="sumario-desc">Felipe Xavier</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/alef-editora/" style="grid-column:1;grid-row:5;">'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/up-brasil/" style="grid-column:1;grid-row:6;">'
      +   '<span class="sumario-secao">Negocios</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">06</span><span class="sumario-desc">Up Brasil</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/tonos/" style="grid-column:1;grid-row:7;">'
      +   '<span class="sumario-secao">Salud mental</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">07</span><span class="sumario-desc">Elisa de Lima</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/aposenta-sp/" style="grid-column:1;grid-row:8;">'
      +   '<span class="sumario-secao">Derecho</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">08</span><span class="sumario-desc">Dra. Simone Baptista</span></span>'
      + '</a>'

      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/msr-device-golden-store/" style="grid-column:2;grid-row:1;">'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/bni-mundi/" style="grid-column:2;grid-row:2;">'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/reconhecimento/" style="grid-column:2;grid-row:3;">'
      +   '<span class="sumario-secao">Reconocimiento</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">11</span><span class="sumario-desc">Reconhecimento BNI</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/massaru-ogata/" style="grid-column:2;grid-row:4;">'
      +   '<span class="sumario-secao">Desarrollo personal</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">12</span><span class="sumario-desc">Massaru Ogata</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/salleven-eventos/" style="grid-column:2;grid-row:5;">'
      +   '<span class="sumario-secao">Eventos empresariales</span>'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/monaco/" style="grid-column:2;grid-row:6;">'
      ...
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/fia-business-school/" style="grid-column:2;grid-row:7;">'
      +   '<span class="sumario-secao">Negocios</span>'
      +   '<span class="sumario-titulo-linha"><span class="sumario-num">15</span><span class="sumario-desc">FIA Business School</span></span>'
      + '</a>'
      + '<a class="sumario-item" href="https://bnibusiness.com.br/es/edicao-02/bni-sao-francisco/" style="grid-column:2;grid-row:8;">'
